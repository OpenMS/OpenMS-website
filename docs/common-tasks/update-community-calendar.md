...
| `summary` | No | Short description shown in the sidebar |
...
- Hero text: `config.yaml` → `params.calendarSection`
- Calendar UI: `layouts/partials/community-calendar-main.html`, `assets/js/community-calendar.js`, `assets/css/community-calendar.css`
